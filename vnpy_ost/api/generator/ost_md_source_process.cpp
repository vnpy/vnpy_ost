void MdApi::processFrontConnected(Task *task)
{
	...
	data["TRetValueType"] = task_data.TRetValueType;
	data["TErrMessageType"] = toUtf(task_data.TErrMessageType);
	delete task_data;
...
void MdApi::processRtnL2IndexMarketData(Task *task)
{
	...
	data["TLocalTimeStampType"] = task_data.TLocalTimeStampType;
	data["TSecuritySourceType"] = task_data.TSecuritySourceType;
	data["TSecurityIdType"] = toUtf(task_data.TSecurityIdType);
	data["TPriceType"] = task_data.TPriceType;
	data["TOrderQty"] = task_data.TOrderQty;
	delete task_data;
